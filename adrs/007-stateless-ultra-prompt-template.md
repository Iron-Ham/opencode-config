...
provided it did not restore Goal state or a persistent Goal-mode continuation
loop.
...
state, token budget, or Goal-mode continuation loop. Ordinary OpenCode
...
background scheduler, persistent objective, or retry loop.
