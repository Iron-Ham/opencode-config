...
|---|---|---|
| `build`, `terra`, `/ultra` | GPT-5.6 Terra xhigh | Production iOS default; `/ultra` enters a hidden unattended policy profile with durable goals and broader bounded delegation, not a different premium model |
